...
public class SubscriptionEntity {
    ...
    // private List<SubscriptionItemEntity> subscriptionItems;
...
//     @Id
//     private String id; // Unique subscription identifier
...
//     @JoinColumn(name = "user_id", nullable = false) // Foreign key to link with User
//     private User user;

//     @OneToOne(cascade = CascadeType.ALL) // One subscription must have exactly one plan
//     @JoinColumn(name = "plan_id", referencedColumnName = "itemPriceId")
//     private SubscriptionItem plan;

    // @OneToMany(cascade = CascadeType.ALL, orphanRemoval = true)
    // @JoinColumn(name = "subscription_id") // Links `SubscriptionItem` addons/charges to `Subscription`
    // private List<SubscriptionItem> addonsOrCharges;

    // Getters and setters
    // Use Lombok for simplicity if preferred
